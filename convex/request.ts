...
export const create = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (requestAlreadySent) {
            console.error(`Request already sent: ${JSON.stringify(requestAlreadySent)}`);
        ...
        if (requestAlreadyReceiver) {
            console.error(`This user has already sent you a request: ${JSON.stringify(requestAlreadyReceiver)}`);
